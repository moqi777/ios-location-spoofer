...
第二步 导入配置
  s2-enable.jpg         小火箭首页，把最上面的开关打开

第三步 打开 HTTPS 解密（20 张，顺序就是操作顺序）
  ...
  s3-10.jpg  警告页再点安装             s3-20.jpg  返回，装完
...
加图前先压一遍。当前这批是 460px 宽、JPEG 质量 70，单张 10~38 KB，27 张共 528 KB：
...
**换图必须先过一遍隐私**。这批里有两张原图带敏感信息，已经靠裁剪去掉了：
  ...
  s2     原图是小火箭首页，带机场订阅名、流量和到期时间 —— 只保留顶部开关
