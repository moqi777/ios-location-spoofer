...
<div class="step">
  <h2 style="margin-bottom:8px">装完之后遇到问题？</h2>
  <p>常见问题挪到<b>选点页最下面</b>了——这一页只有还没装好的人看得到（装好之后打开会直接跳回选点页），
    而那些问题恰恰都是装好之后才会遇到的，放这儿等于写给看不到的人。</p>
  <p>选点页拉到底，「常见问题」里有：改完没生效怎么排查、晚上会掉回真实位置怎么办、
    户外容易跳回怎么处理、以及定位原理和抗检测说明。</p>
</div>
